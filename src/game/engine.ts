...
export const speedMathTips: SpeedMathTip[] = [
  {
    id: 'round-and-adjust',
    title: 'Yuvarla ve d�zelt',
    example: '48 + 37 = 50 + 37 − 2 = 85',
    explanation:
      'Toplamada bir say�y� yak�n onlu�a yuvarla, fazlal��� sonra ��kar. Zihinde iki ad�m, ama her ad�m �ok kolay.',
    category: 'toplama',
  },
  {
    id: 'split-by-place',
    title: 'Basamaklara ay�r',
    example: '263 + 148 → (200+100) + (60+40) + (3+8) = 411',
    explanation:
      'B�y�k say�lar� y�zler, onlar ve birler olarak �� par�aya ay�r. Her par�ay� ayr� topla, sonra birle�tir.',
    category: 'toplama',
  },
  {
    id: 'count-up-subtraction',
    title: '��karmada yukar� say',
    example: '82 − 57 → 57→60 (+3), 60→82 (+22), toplam 25',
    explanation:
      '��karma yerine k���k say�dan b�y�k say�ya do�ru say. Toplamda ka� ilerledi�in cevab�n� verir.',
    category: 'cikarma',
  },
  {
    id: 'nines-trick',
    title: '9 ile �arpman�n p�f noktas�',
    example: '9 � 7 = 10�7 − 7 = 63',
    explanation:
      '9 yerine �nce 10 ile �arp, sonra bir kez ��kar. Her zaman iki basamak daha h�zl� sonu�.',
    category: 'carpma',
  },
  {
    id: 'five-trick',
    title: '5 ile �arp = 10 ile �arp, ikiye b�l',
    example: '5 � 48 = (10�48) � 2 = 240',
    explanation:
      '5 ile �arpmak zordursa �nce 10 ile �arp, sonra yar�ya indir. Tek ad�m gibi h�zl�.',
    category: 'carpma',
  },
  {
    id: 'double-halve',
    title: '�kiye katla, ikiye b�l',
    example: '16 � 25 = 8 � 50 = 4 � 100 = 400',
    explanation:
      'Bir say�y� ikiye katlay�p di�erini ikiye b�lmek �arp�m� de�i�tirmez. Bu yolla yuvarlak bir e�lenik bul.',
    category: 'carpma',
  },
  {
    id: 'eleven-two-digit',
    title: '11 ile 2 basamakl� �arpma',
    example: '11 � 45 → 4 _ 5, ortaya 4+5=9 → 495',
    explanation:
      '�ki basamakl� bir say�y� 11 ile �arpmak i�in basamaklar� ay�r, aralar�na toplam� yaz. Elde varsa sola aktar.',
    category: 'carpma',
  },
  {
    id: 'square-ends-in-five',
    title: '5 ile biten say�n�n karesi',
    example: '35� → 3�4=12, sonra 25 → 1225',
    explanation:
      '5 ile biten iki basamakl� say�n�n karesini al: onluk basama��n� bir fazlas�yla �arp, sonuna 25 ekle.',
    category: 'carpma',
  },
  {
    id: 'division-as-reverse',
    title: 'B�lmeyi �arpmaya �evir',
    example: '72 � 8 → "8 ka� ile �arp�l�rsa 72?" → 9',
    explanation:
      'B�lme sorusunu "�arp�m tablosunda hangi de�er?" olarak sor. Cevap daha �abuk gelir.',
    category: 'bolme',
  },
  {
    id: 'divisibility-check',
    title: 'B�l�nebilirlik ipu�lar�',
    example: '2: son rakam �ift � 3: rakamlar toplam� 3 ile b�l�n�r � 5: son 0 veya 5',
    explanation:
      'B�lme sorusunda cevab�n tam ��k�p ��kmayaca��n� h�zl�ca kontrol etmek hata pay�n� azalt�r.',
    category: 'bolme',
  },
  {
    id: 'estimate-first',
    title: '�nce tahmin et, sonra ��z',
    example: '487 + 319 ≈ 500 + 320 = 820 (ger�ek: 806)',
    explanation:
      '�nce zihnen yakla��k cevab� kestir. Ger�ek sonu� bu tahminden �ok farkl�ysa tekrar kontrol et.',
    category: 'genel',
  },
  {
    id: 'check-by-reversing',
    title: 'Ters i�lemle do�rula',
    example: '144 � 12 = 12, kontrol: 12 � 12 = 144 ✓',
    explanation:
      'Cevab� teslim etmeden �nce ters i�lemi zihninde yap. Bir saniye kaybedersin ama yanl��� yakalars�n.',
    category: 'genel',
  },
]
