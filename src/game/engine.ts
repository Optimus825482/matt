...
export const speedMathTips: SpeedMathTip[] = [
  {
    ...
    example: '48 + 37 = 50 + 37 − 2 = 85',
    explanation:
      'Toplamada bir sayıyı yakın onluğa yuvarla, fazlalığı sonra çıkar. Zihinde iki adım, her adım kolay.',
    category: 'toplama',
  },
  {
    id: 'split-by-place',
    title: 'Basamaklara ayır',
    example: '263 + 148 → (200+100) + (60+40) + (3+8) = 411',
    explanation:
      'Büyük sayıları yüzler, onlar ve birler olarak üç parçaya ayır. Her parçayı ayrı topla, sonra birleştir.',
    category: 'toplama',
  },
  {
    id: 'count-up-subtraction',
    title: 'Çıkarmada yukarı say',
    example: '82 − 57 → 57→60 (+3), 60→82 (+22), toplam 25',
    explanation:
      'Çıkarma yerine küçük sayıdan büyük sayıya doğru say. Toplamda kaç ilerlediğin cevabı verir.',
    category: 'cikarma',
  },
  {
    id: 'nines-trick',
    title: '9 ile çarpmanın püf noktası',
    example: '9 × 7 = 10×7 − 7 = 63',
    explanation:
      '9 yerine önce 10 ile çarp, sonra bir kez çıkar. Her zaman iki basamak daha hızlı sonuç.',
    category: 'carpma',
  },
  {
    id: 'five-trick',
    ...
    explanation:
      '5 ile çarpmak zordursa önce 10 ile çarp, sonra yarıya indir. Tek adım gibi hızlı.',
    category: 'carpma',
  },
  {
    id: 'double-halve',
    title: 'İkiye katla, ikiye böl',
    example: '16 × 25 = 8 × 50 = 4 × 100 = 400',
    explanation:
      'Bir sayıyı ikiye katlayıp diğerini ikiye bölmek çarpımı değiştirmez. Bu yolla yuvarlak bir eşlenik bul.',
    category: 'carpma',
  },
  {
    id: 'eleven-two-digit',
    title: '11 ile 2 basamaklı çarpma',
    example: '11 × 45 → 4 _ 5, ortaya 4+5=9 → 495',
    explanation:
      'İki basamaklı bir sayıyı 11 ile çarpmak için basamakları ayır, aralarına toplamı yaz. Elde varsa sola aktar.',
    category: 'carpma',
  },
  {
    id: 'square-ends-in-five',
    title: '5 ile biten sayının karesi',
    example: '35² → 3×4=12, sonra 25 → 1225',
    explanation:
      '5 ile biten iki basamaklı sayının karesini al: onluk basamağını bir fazlasıyla çarp, sonuna 25 ekle.',
    category: 'carpma',
  },
  {
    id: 'division-as-reverse',
    title: 'Bölmeyi çarpmaya çevir',
    example: '72 ÷ 8 → "8 kaç ile çarpılırsa 72?" → 9',
    explanation:
      'Bölme sorusunu çarpım tablosunda hangi değer sorusuna çevir. Cevap daha çabuk gelir.',
    category: 'bolme',
  },
  {
    id: 'divisibility-check',
    title: 'Bölünebilirlik ipuçları',
    example: '2: son rakam çift · 3: rakamlar toplamı 3 ile bölünür · 5: son 0 veya 5',
    explanation:
      'Bölme sorusunda cevabın tam çıkıp çıkmayacağını hızlıca kontrol etmek hata payını azaltır.',
    category: 'bolme',
  },
  {
    id: 'estimate-first',
    title: 'Önce tahmin et, sonra çöz',
    example: '487 + 319 ≈ 500 + 320 = 820 (gerçek: 806)',
    explanation:
      'Önce zihinden yaklaşık cevabı kestir. Gerçek sonuç bu tahminden çok farklıysa tekrar kontrol et.',
    category: 'genel',
  },
  {
    id: 'check-by-reversing',
    title: 'Ters işlemle doğrula',
    example: '144 ÷ 12 = 12, kontrol: 12 × 12 = 144 ✓',
    explanation:
      'Cevabı teslim etmeden önce ters işlemi zihninde yap. Bir saniye kaybedersin ama yanlışı yakalarsın.',
    category: 'genel',
  },
]
